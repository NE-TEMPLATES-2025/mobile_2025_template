...
import { AppleSvg, CheckSvg, ChevronLeftBlue, EyeOpen, EyeSvg, GoogleSvg, MailGray } from '@/assets/svgs'
  ...
  return (
    ...
    <ScrollView contentContainerStyle={{
      ...
      <View className=' bg-secondary w-full px-6 pt-20 pb-10'>
       ...
       <Text className=' text-gray-1 text-[14px] font-semibold mt-3 mb-12'>Create an Account to Continue your all courses</Text>
       ...
       <View className=' flex flex-row w-full items-center gap-3 mb-4'>
        <CheckSvg/>
        <Text className='text-[14px] font-semibold text-gray-1'>Agree to Terms & Conditions</Text>
       ...
       <Text className='text-gray-1 text-[14px] text-center font-bold mb-6'>Or Continue With</Text>
       ...
       <TouchableOpacity className='h-[48px] w-[48px] bg-white rounded-full shadow-lg  items-center justify-center'>
        ...
        <Text className='font-medium text-[15px] text-gray-1 text-center'>Already have an Account?
          {" "} 
          <Link className='underline text-primary font-bold text-center' href="/(onboarding)/login">SIGN IN</Link>
          </Text>
      </View>
